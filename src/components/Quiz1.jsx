    ...
    lessons: [
      {
        ...
        content: "Интернет – это как большая паутина, которая связывает миллионы компьютеров невидимой сетью. С помощью него можно узнавать разные новости, смотреть видео и картинки, играть и общаться с друзьями. Если ты отправляешь сообщение, то оно быстро «бежит по паутине» к другому человеку. Чтобы это работало, нужны компьютеры, телефоны и специальные устройства – роутеры."
      },
      {
        title: "Как мы используем Интернет?",
        content: "Дети и взрослые используют интернет по-разному, например: Смотреть обучающие ролики и мультфильмы;Слушать музыку;Общаться с друзьями в социальных сетях;Играть в игры;Искать ответы на вопросы и др.Однако важно помнить, что Интернет это не только веселье, но и ответственность! Надо уметь пользоваться им правильно."
      },
      {
        title: "Виды сайтов",
        content: "В Интернете есть разные сайты: Образовательные – например, где можно учиться. Игровые – для развлечений. Социальные сети – для общения. Информационные – новости, прогноз погоды. Интернет-магазины – где покупают игрушки, одежду, книги. У каждого сайта есть свой адрес, как у дома. Он называется «URL». Пример: «ya.ru», «ru.wikipedia.org»."
      },
      {
        title: "Кто помогает попасть в Интернет?",
        content: "Чтобы работал Интернет, нужно:Устройство (телефон/планшет/компьютер);Подключение к Интернету (Wi-Fi/мобильный интернет);Браузер – специальное приложение, которое помогает заходить на сайты (например Яндекс Браузер, Safari).Когда ты вводишь адрес сайта, браузер помогает найти и открыть нужную страницу."
      }
    ],
    questions: [
      {
