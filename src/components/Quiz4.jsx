  ...
  lessons: [
    {
      ...
      content: "Личная информация – это любые данные о человеке, которые позволяют узнать, кто он. Например: Имя и фамилия; Возраст; Адрес; Номер телефона; Логины и пароли; Фотографии; Местоположение. Эти данные называются персональными. Они принадлежат только вам, и важно защищать их, чтобы никто из посторонних не смог их использовать во вред."
    },
    {
      title: "Почему важно защищать личную информацию",
      content: "Если личная информация попадет в руки недоброжелателей, например, мошенников, то это может быть очень опасно! Они могут: Пытаться взломать ваш аккаунт; Отправлять от вашего имени сообщения; Получить доступ к вашим родителям или друзьям; Использовать полученную информацию во вред вам. Поэтому очень важно никому не рассказывать свои пароли, даже друзьям! Не выкладывать в интернет личные данные и не доверять незнакомцам."
    },
    {
      title: "Пароль – твой секретный ключ",
      content: "Пароль – это секретный набор символов, который защищает вашу информацию. Хороший и надежный пароль должен быть: Длинным (не менее 8 символов); Содержит буквы (строчные и заглавные), цифры и символы; Не содержит имя или дату рождения; Никому не рассказывается! Если кто-то узнает твой пароль, то его можно и нужно изменить."
    },
    {
      title: "Безопасность в социальных сетях",
      content: "Запомни! Эти вещи делать нельзя: Добавлять в друзья незнакомцев; Выкладывать адрес дома или школы; Писать, когда и куда ты пойдешь; Выкладывать фото документов. Иногда злоумышленники создают фальшивые страницы, чтобы обмануть других. Поэтому, если кто-то пишет странные сообщения, просит деньги или личные данные – сразу скажи взрослым."
    }
  ],
  questions: [
    {
        ...
        Назад
          ...
          {stage === 'lessons' ? (
              ...
              <Typography variant="body1" paragraph>
                  {learningContent.lessons[currentLesson].content}
              </Typography>
